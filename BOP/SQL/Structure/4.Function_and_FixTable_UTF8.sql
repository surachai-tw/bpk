...
INSERT INTO bpk_fix_item_type VALUES('0', 'DRUG', '01');
INSERT INTO bpk_fix_item_type VALUES('1', 'LAB', '02');
INSERT INTO bpk_fix_item_type VALUES('2', 'XRAY', '03');
INSERT INTO bpk_fix_item_type VALUES('3', 'SERVICE', '04');
INSERT INTO bpk_fix_item_type VALUES('4', 'SUPPLY', '05');
INSERT INTO bpk_fix_item_type VALUES('6', 'DENTAL', '06');
INSERT INTO bpk_fix_item_type VALUES('7', 'OPERATION', '07');
INSERT INTO bpk_fix_item_type VALUES('8', 'FOOD', '08');
INSERT INTO bpk_fix_item_type VALUES('10', 'DOCTOR FEE', '09');
INSERT INTO bpk_fix_item_type VALUES('11', 'BLOOD', '10');
INSERT INTO bpk_fix_item_type VALUES('12', 'WASTE', '11');
INSERT INTO bpk_fix_item_type VALUES('13', 'PURCHASE', '12');
...
BEGIN 
    SELECT INTO rec TRIM(COALESCE(fx.description, '''')) AS description FROM bpk_fix_item_type fx 
    WHERE fx.bpk_fix_item_type_id=id;
...
INSERT INTO bpk_hospital_item VALUES('0', 'ยานอก รพ.', '1');
INSERT INTO bpk_hospital_item VALUES('1', 'สำหรับขายให้ผู้ป่วย', '2');
...
DECLARE 
    ...
    rec_desc VARCHAR(255):= '''';
BEGIN 
    SELECT INTO rec TRIM(COALESCE(hitm.description, '''')) AS description FROM bpk_hospital_item hitm 
    WHERE hitm.bpk_hospital_item_id=id;
...
DECLARE 
    ...
    rec_desc VARCHAR(255):= '''';
BEGIN 
    SELECT INTO rec TRIM(COALESCE(description_th, '''')) AS description FROM base_unit  
