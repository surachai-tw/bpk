...
(
    ...
    pverify_spid VARCHAR(255) DEFAULT '',
    pordered_by_service_point VARCHAR(255) DEFAULT '',
    pverify_deptid VARCHAR(255) DEFAULT '',
    pordered_by_department VARCHAR(255) DEFAULT '',
