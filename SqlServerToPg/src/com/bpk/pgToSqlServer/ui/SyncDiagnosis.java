 ...
 * @author surachai.tw
 */
public class SyncDiagnosis implements Runnable
{
    ...
    public void run()
    {
        ...
        try
        {
            listVisitDate = aDocScanDAO.listVisitDate(backDate);
            if (Utility.isNotNull(listVisitDate))
            {
                System.out.println("All visit date in last "+backDate+" days = " + listVisitDate.size());
