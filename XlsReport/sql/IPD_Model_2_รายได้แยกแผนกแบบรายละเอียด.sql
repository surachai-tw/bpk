...
(
    ...
    acccredit.financial_discharge_date "วันที่จำหน่าย", 
    acccredit.financial_discharge_time "เวลาที่จำหน่าย", 
    acccredit.hn "HN", 
    acccredit.vn "VN", 
    acccredit.an "AN", 
    ...
    GROUP BY visit_id, acccredit.visit_date, visit_time, acccredit.financial_discharge_date, financial_discharge_time, acccredit.hn, acccredit.vn, acccredit.an, 
    acccredit.patient_name, pverify_deptid, pordered_by_department
) tmp 
ORDER BY "ชื่อแผนก" COLLATE "th_TH", "วันที่รับบริการ", "เวลาที่รับบริการ", "AN" 
