SELECT 
"วันที่รับบริการ", "เวลาที่รับบริการ", "HN", "VN", "ชื่อ-สกุล", "รหัสแผนก", "ชื่อแผนก", "รายการสั่งตรวจ/รักษา", "ต้นทุนยา", "ต้นทุนเวชภัณฑ์", "ต้นทุนอื่นๆ", "ค่ายา", "ค่าเวชภัณฑ์", "Lab", "X-ray", "ทันตกรรม", "กายภาพ", "ล้างไต", "ค่าอุปกรณ์", "ค่าแพทย์", "ค่าบริการพยาบาล", "ค่าบริการโรงพยาบาล", "ค่าห้อง", "ค่าอาหาร", "เหมาจ่าย", "อื่นๆ", "รวมค่าบริการ", "ส่วนลด", "ยอดสุทธิ", 
...
(
    ...
    verify_deptid "รหัสแผนก", 
    ordered_by_department "ชื่อแผนก", 
    ...
    acccredit.patient_name, verify_deptid, ordered_by_department, item_description 
) tmp 
ORDER BY "วันที่รับบริการ", "เวลาที่รับบริการ", "VN", "ชื่อแผนก" COLLATE "th_TH", "รายการสั่งตรวจ/รักษา" COLLATE "th_TH"
