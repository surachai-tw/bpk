...
(
    ...
    INNER JOIN visit ON order_item.visit_id=visit.visit_id AND visit.fix_visit_type_id='1' AND visit.financial_discharge='1' 
    WHERE
    visit.financial_discharge_date=Cast(CURRENT_DATE-1 AS VARCHAR(10))
) tmp 
