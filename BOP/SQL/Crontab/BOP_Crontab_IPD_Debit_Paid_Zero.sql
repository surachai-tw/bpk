...
SELECT
    ...
    (SELECT ipd_attending_physician.employee_id FROM ipd_attending_physician INNER JOIN admit ON ipd_attending_physician.admit_id=admit.admit_id WHERE ipd_attending_physician.priority='1' AND admit.visit_id=visit.visit_id LIMIT 1) main_doctor_id, 
...
-- WHERE receipt.visit_id='115061800105908101'  
-- WHERE receipt.visit_id='114122909152916901' 
-- WHERE receipt.visit_id='115010517223413101' 
-- WHERE receipt.visit_id='115012812133989501' 
-- WHERE receipt.visit_id='115010612502250901' 
