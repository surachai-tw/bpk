...
public class BpkUtility {
    ...
    /** แปลงข้อมูลจาก yyyy-mm-dd String และ hh-mm-ss String ในหน่วย 24 ชม. ให้เป็น Date
     * ส่งค่าออกเป็น ค.ศ. เสมอ
     */
    public static Date getDateChristFromString(String yyyy_mm_dd, String hh_mm_ss)
    {
        // วันที่ต้องมีครบทั้ง ปี เดือน วัน ส่วนเวลาอาจจะมีแค่ ชั่วโมง กับ นาที ก็ได้
