/*
 * FrmPgToSqlServer.java
 *
 * Created on Aug 16, 2015, 8:55:43 AM
 */
package com.bpk.pgToSqlServer.ui;

import com.bpk.pgToSqlServer.dao.PgToSqlServerDAO;
 ...
 * @author surachai.tw
 */
public class FrmPgToSqlServer extends javax.swing.JFrame
{

    /** Creates new form FrmPgToSqlServer */
    public FrmPgToSqlServer()
    {
        try
        {
        ...
        PgToSqlServerDAO tmpXlsReportDAO = new PgToSqlServerDAO();
    ...
    private void initComponents() {
        ...
        aTxtSqlPath.setText("D:\\BPK\\trunk\\PgToSqlServer\\sql");
        ...
        aTxtFromDate.setText("2010-09-01");
    ...
    public void execute(String inputFromDate, String inputToDate)
    {
        ...
        PgToSqlServerDAO aPgToSqlServerDAO = new PgToSqlServerDAO();
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                FrmPgToSqlServer aFrmExport = new FrmPgToSqlServer();
                aFrmExport.setVisible(true);

                if(autoRun)
                {
                    aFrmExport.setExecuteDate(FrmPgToSqlServer.getCurrentDateForExecute(-1));
                    aFrmExport.execute();
                    System.exit(1);
                }
            }
