SELECT 
"วันที่รับบริการ", "เวลาที่รับบริการ", "HN", "VN", "ชื่อ-สกุล", "รหัสแผนก", "ชื่อแผนก", "ต้นทุนยา", "ต้นทุนเวชภัณฑ์", "ต้นทุนอื่นๆ", "ค่ายา", "ค่าเวชภัณฑ์", "Lab", "X-ray", "ทันตกรรม", "กายภาพ", "ล้างไต", "ค่าอุปกรณ์", "ค่าแพทย์", "ค่าบริการพยาบาล", "ค่าบริการโรงพยาบาล", "ค่าห้อง", "ค่าอาหาร", "เหมาจ่าย", "อื่นๆ", "รวมค่าบริการ", "ส่วนลด", "ยอดสุทธิ", 
...
ORDER BY "ชื่อแผนก"  COLLATE "th_TH", "วันที่รับบริการ", "เวลาที่รับบริการ"
